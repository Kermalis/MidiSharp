...
namespace MidiSharp.Tests
{
    ...
    public sealed class SequenceTests
    {
        ...
        static MidiSequence CreateAllInclusiveSequence()
        {
            ...
            track1.Events.Add(new CopyrightTextMetaMidiEvent(track1, 0, "Copyright"));
            track1.Events.Add(new CuePointTextMetaMidiEvent(track1, 1, "CuePoint"));
            track1.Events.Add(new DeviceNameTextMidiEvent(track1, 2, "DeviceName"));
            track1.Events.Add(new InstrumentTextMetaMidiEvent(track1, 3, "Instrument"));
            track1.Events.Add(new LyricTextMetaMidiEvent(track1, 4, "Lyric"));
            track1.Events.Add(new MarkerTextMetaMidiEvent(track1, 5, "Marker"));
            track1.Events.Add(new ProgramNameTextMetaMidiEvent(track1, 6, "ProgramName"));
            track1.Events.Add(new SequenceTrackNameTextMetaMidiEvent(track1, 7, "SequenceTrackName"));
            track1.Events.Add(new TextMetaMidiEvent(track1, 7, "Text"));
            track1.Events.Add(new EndOfTrackMetaMidiEvent(track1, 0));

            track2.Events.Add(new ChannelPrefixMetaMidiEvent(track2, 0, 17));
            track2.Events.Add(new KeySignatureMetaMidiEvent(track2, 1, Key.Flat4, Tonality.Minor));
            track2.Events.Add(new MidiPortMetaMidiEvent(track2, 2, 1));
            track2.Events.Add(new ProprietaryMetaMidiEvent(track2, 3, new byte[] { 0, 1, 2, 3 }));
            track2.Events.Add(new SequenceNumberMetaMidiEvent(track2, 4, 123));
            track2.Events.Add(new SMPTEOffsetMetaMidiEvent(track2, 0, 1, 2, 3, 4, 5));
            track2.Events.Add(new TempoMetaMidiEvent(track2, 0, 123));
            track2.Events.Add(new TimeSignatureMetaMidiEvent(track2, 0, 1, 2, 3, 4));
            track2.Events.Add(new UnknownMetaMidiEvent(track2, 0, 123, new byte[] { 1, 2, 3 }));

            track2.Events.Add(new EndOfTrackMetaMidiEvent(track2, 0));
