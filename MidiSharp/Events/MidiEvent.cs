...
namespace MidiSharp.Events
{
    ...
    public abstract class MidiEvent
    {
        ...
        /// <summary>The track that owns this event.</summary>
        public MidiTrack Owner { get; internal set; }
        ...
        /// <summary>Calculates the ticks it takes to reach this event.</summary>
