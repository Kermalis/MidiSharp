...
namespace MidiSharp
{
    ...
    public sealed class MidiSequence : IEnumerable<MidiTrack>
    {
        ...
        public MidiTrackCollection Tracks { get; }
        ...
        IEnumerator IEnumerable.GetEnumerator() { return Tracks.GetEnumerator(); }

        /// <summary>Gets an enumerator for the tracks in the sequence.</summary>
        /// <returns>An enumerator for the tracks in the sequence.</returns>
        public IEnumerator<MidiTrack> GetEnumerator() { return Tracks.GetEnumerator(); }
        ...
        public void Save(Stream outputStream)
        {
            ...
            if (Tracks.Count < 1) throw new InvalidOperationException("No tracks have been added.");
